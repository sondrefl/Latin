...
if __name__ == "__main__":
        ...
        for _ in range(10):
            ...
            try:
                ...
                if answer <= len(category) and answer > 0:
                    ...
                    latin = latin[category[answer-1][1]:category[answer-1][2]]
                    norsk = norsk[category[answer-1][1]:category[answer-1][2]]

                    rep = quiz_med_alternativ(latin, norsk, d, d_nor)
                else:
    ...
    #print(len(latin), len(norsk))
    #word = random.choice(latin)

    #print(f"word = {word}, dic = {d[word]}")
